...
describe('validate the vbank authoring flow', () => {
  before(() => {
    cy.AEMLogin()
  ...
  beforeEach(() => {
    cy.AEMLogin()
    cy.VBANKCreateContentPage('/content/vbank').then(($el) => {
  ...
  after(() => {
    cy.AEMDeleteTestPages('/content/vbank')
  })
  ...
  it('should be able to author and publish a page', () => {
    ...
    cy.get('coral-list-item[value="/apps/vbank/components/helloworld"]').click()
