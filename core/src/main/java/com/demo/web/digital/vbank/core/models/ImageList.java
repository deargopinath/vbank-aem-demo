package com.demo.web.digital.vbank.core.models;
...
/**
 * Represents the VBANK Image List Component
 */
public interface ImageList {
    ...
    interface ListItem{
        /**
         * This method returns a resource that is an VBANK Image Component resource (rather than an image binary, such as a DAM asset).
         * This resource is intended to be rendered via the VBANK Image Component's logic via a Sling include of this resource.
         *
