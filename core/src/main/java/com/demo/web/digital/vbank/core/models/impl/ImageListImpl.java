...
public class ImageListImpl implements ImageList {
    ...
    protected static final String RESOURCE_TYPE = "vbank/components/image-list";
     ...
     * the VBANK Image List component, following the delegation pattern.
     *
    ...
    private class ImageListItemImpl implements ImageList.ListItem {
        private static final String IMAGE_RESOURCE_TYPE = "vbank/components/image";
