package com.demo.web.digital.vbank.core.models.impl;

import com.demo.web.digital.vbank.core.models.ImageList;
...
class ImageListImplTest {
    ...
    @BeforeEach
    void setUp() {
        ctx.load().json("/com/demo/web/digital/vbank/core/models/impl/ImageListImplTest.json", "/content");
    ...
    void getData() throws RepositoryException, IllegalAccessException, NoSuchFieldException {
        ...
        assertEquals("vbank/components/image-list", actual.getData().getType());
        ...
        assertEquals("vbank/components/image-list/image-list-item", listItemData.getType());
