                                ...
                                <div class="responsivegrid cmp-layout-container--modal aem-GridColumn aem-GridColumn--default--12">
                                    <div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                                        ...
                                        <div class="sign-in-form aem-GridColumn aem-GridColumn--default--12">
                                            <div class="vbank-sign-in-form">
                                                <form method="POST" action="/system/sling/login/j_security_check" id="vbank-sign-in-form"
                                                      class="vbank-sign-in-form__form">
                                                    <input type="hidden" name="charset" value="🐶"/>
                                                    <input type="hidden" name="j_validate" value="true"/>
                                                    <input type="hidden" name="sling.auth.redirect"
                                                           value="/content/vbank/language-masters/en.html"/>
                                                    <div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                            ...
                            <div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                                <div class="responsivegrid cmp-layout-container--modal aem-GridColumn aem-GridColumn--default--12">
                                    <div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                                        ...
                                        <div class="sign-in-form aem-GridColumn aem-GridColumn--default--12">
                                            <div class="vbank-sign-in-form">
                                                <form method="POST" action="/system/sling/login/j_security_check" id="vbank-sign-in-form" class="vbank-sign-in-form__form">
                                                    <input type="hidden" name="charset" value="🐶"/>
                                                    <input type="hidden" name="j_validate" value="true"/>
                                                    <input type="hidden" name="sling.auth.redirect"/>
                                                    <div class="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                                                        <div class="button aem-GridColumn aem-GridColumn--default--12">
                                                            <button type="SUBMIT" class="cmp-form-button" name="resource" value="/content/vbank/us/en.html">SIGN OUT</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
