...
class Search {
  ...
  get markup() {
    return (
      ...
      '<form class="cmp-search__form" data-cmp-hook-search="form" method="get" action="/content/vbank/en/sports/la-skateparks.searchresults.json/_jcr_content/root/header/search" autocomplete="off">' +
