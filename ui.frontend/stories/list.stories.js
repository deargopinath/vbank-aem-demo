...
class List {
  ...
  get markup() {
    return (
      ...
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/vbank/en/sports/five-gyms-la.html">' +
      ...
      '<li class="cmp-list__item">' +
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/vbank/en/sports/la-skateparks.html">' +
      ...
      '<li class="cmp-list__item">' +
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/vbank/en/sports/mountain-bike-routes.html">' +
