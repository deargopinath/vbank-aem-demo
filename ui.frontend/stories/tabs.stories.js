...
class Tabs {
  ...
  get markup() {
    return (
      ...
      '<article class="cmp-contentfragment" data-cmp-contentfragment-model="vbank/models/adventure" data-cmp-contentfragment-path="/content/dam/vbank/en/adventures/surf-nicaragua/nicaragua-surf-trip">' +
